<?php
	...
	if (count($results)>0){
		...
		$_SESSION["name"] = $results["staff_name_first"]; //creates SESSION variable with the name in it.
		$_SESSION["last_name"] = $results["staff_name_last"]; //creates SESSION variable with the last name in it.
